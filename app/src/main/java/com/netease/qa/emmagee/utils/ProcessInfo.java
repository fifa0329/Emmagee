...
public class ProcessInfo {
	...
	public List<Program> getRunningProcess(Context context) {
		...
		List<Program> progressList = new ArrayList<Program>();
	 ...
	 * @return pid
	 */
	public Program getProgrameByPackageName(Context context, String packageName) {
		List<Program> processList = getRunningProcess(context);
